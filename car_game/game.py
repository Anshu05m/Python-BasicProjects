...
intro_bg = pygame.image.load("background.jpg")
instruction_bg = pygame.image.load("background2.jpg")
car_width = 56
...
def introduction():
    ...
    while introduction:
        ...
        textSurf,textRect=text_objects("This is the car game, enjoy it!",smalltext)
...
def countdown_bg():
    ...
    gamedisplays.blit(backgroundimg,(0,200))
    gamedisplays.blit(backgroundimg,(0,400))
    gamedisplays.blit(backgroundimg,(700,0))
    gamedisplays.blit(backgroundimg,(700,200))
    gamedisplays.blit(backgroundimg,(700,400))
    ...
    text=font.render("Passed: 0",True, pink)
...
def obstacle(obs_startx, obs_starty, obs):
    if obs == 0:
        obs_img = pygame.image.load("car.jpg")
    elif obs == 1:
        obs_img = pygame.image.load("car1.jpg")
    elif obs == 2:
    ...
    gamedisplays.blit(obs_img, (obs_startx, obs_starty))
   
def score_system(passed, score):
    font = pygame.font.SysFont(None, 25)
    text = font.render("Passed : " + str(passed), True, pink)
...
def game_loop():
    ...
    while not bumped:
        ...
        gamedisplays.blit(backgroundimg,(0,rel_y-backgroundimg.get_rect().width))
        gamedisplays.blit(backgroundimg,(700,rel_y-backgroundimg.get_rect().width))
        if rel_y<800:
            gamedisplays.blit(backgroundimg,(0,rel_y))
            gamedisplays.blit(backgroundimg,(700,rel_y))
